...
Accordingly, my field of research is <b>Applied Econometrics</b> and in particular, the combination of <b>Quantitative Marketing</b> and <b>Psychometric Methods</b>. This includes statistical models for decisions at the individual as well as the aggregated level and their computational efficient estimation within probabilistic formulations (exact and approximate Bayesian inference). I'm also working on topics related to auxiliary information and prior specifications, uncertainty quantification in predictions (quantile models, deep ensembles, probabilistic neural networks) and feature importance attribution methods (insertion and deletion metrics, Shapley values in particular).
