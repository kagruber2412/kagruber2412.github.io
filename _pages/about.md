...
Accordingly, my field of research is <b>Applied Econometrics</b> and in particular, the combination of <b>Quantitative Marketing</b> and <b>Psychometric Methods</b>. This includes statistical models for decisions at the individual as well as the aggregate level (e.g., item responses, product choices, user conversions, but also budget allocation) and their computational efficient estimation within probabilistic (exact & approximate Bayesian) formulations. I'm also working on topics related to generalized linear/semiparametric mixed models, auxiliary information and prior specifications, probabilistic neural networks and uncertainty quantification in predictions (quantile models, deep ensembles).
